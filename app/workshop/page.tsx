...
export default function WorkshopPage() {
  ...
  const weeks = [
    {
      num: "01",
      title: "החלל שנוצר ביני לבין הילד שלי — יש לו שם",
      text: "מה קורה ביולוגית ונוירולוגית בגיל 8-11 — ולמה הילד שמולך הוא לא הילד שגידלת. הוואקום של אחה\"צ: מ-13:00 שיוצא מהלימודים ועד שאת מגיעה — ולמה בדיוק בשעות האלה הכי הרבה ריבים פורצים.",
    },
    {
      num: "02",
      title: "לא אשמים, אבל כן אחראיים",
      text: "ויסות הורי — כי כשאתם מאבדים את עצמכם, הוא מאבד אתכם. נלמד מה שורשי האהבה האמיתיים, ונכיר שיטה שמאפשרת לך להחזיק אותו כשהוא מתפרק — מבלי להתפרק איתו.",
    },
    {
      num: "03",
      title: "גבולות — איך עושים את זה נכון?",
      text: "מה קורה אצלו באמת כשאת אומרת לו 'לא' — ולמה גבולות הם דווקא מה שהוא הכי צריך ממך. הבכי שמוציא אותך מדעתך — ולמה הוא בעצם סימן טוב. וניהול מסכים בלי שכל ערב יהפוך לקרב.",
    },
    {
      num: "04",
      title: "אמנות התיקון",
      text: "כולנו מתפוצצים — זה לא השאלה. השאלה היא מה עושים ב-10 הדקות אחרי. תיקון בארבעה צעדים שאפשר ליישם מחר בבוקר. ומשהו שתגלי על עצמך ועליו בדיוק ברגעים האלה — שיגרום לפיצוץ לבנות ביניכם קשר במקום לשבור אותו.",
    },
  ];
    ...
    <main dir="rtl" className="font-assistant bg-[#FAFAF8] text-[#2C3E5A] overflow-x-hidden">
      ...
      <section ref={heroRef} className="relative min-h-screen flex flex-col justify-center overflow-hidden">
        ...
        >
          ...
          >
            ...
            <span className="text-white/90 text-sm font-medium">מחזור ראשון · 10 מקומות בלבד · 497 ש&quot;ח</span>
          </motion.div>
          ...
          >
            <span>26.05.26</span>
            <span>·</span>
            <span>ימי שלישי 20:45–22:15</span>
            <span>·</span>
            <span>גוגל מיט</span>
          </motion.div>
        </motion.div>
      ...
      <div ref={statsRef} className="bg-[#2C3E5A] py-10 px-6">
        <div className="max-w-3xl mx-auto grid grid-cols-2 gap-6 text-center">
          {[
            { value: count4, suffix: "", label: "מפגשים" },
            { value: count10, suffix: "", label: "מקומות בלבד" },
          ].map((stat, i) => (
            <motion.div
              key={i}
              initial={{ opacity: 0, y: 20 }}
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              ...
              "מ-13:00 שהוא יוצא מהלימודים ועד 17:00 שאת מגיעה הביתה — ארבע שעות שאת לא שם. ואת כבר יודעת מה מחכה. הפיצוץ לא מחכה לדלת. לפעמים הוא מתחיל כבר בטלפון, באמצע יום עבודה.",
            ].map((text, i) => (
              <motion.p
                key={i}
      ...
      <section className="py-16 lg:py-20 px-6 lg:px-16 bg-[#2C3E5A] relative overflow-hidden">
        <Orb className="w-96 h-96 bg-[#A0522D] -top-20 -right-20" delay={0} />
        <div className="max-w-3xl mx-auto relative z-10 text-center">
          <motion.h2
            className="text-3xl lg:text-5xl font-extrabold text-white leading-tight mb-4"
            initial={{ opacity: 0, y: 24 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          >
          ...
          <motion.p
            className="text-2xl lg:text-3xl font-extrabold text-[#C8956C] leading-tight"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
      ...
      <section className="py-20 lg:py-32 px-6 lg:px-16 bg-[#F5F4F2] relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          {/* Ferrari reframe */}
          <motion.div
            className="relative bg-[#2C3E5A] p-8 lg:p-10 overflow-hidden mb-6"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          >
            ...
            <p className="text-[#C8956C] text-2xl font-bold mb-3">
              מנוע של פרארי. ברקסים של אופניים.
            </p>
            ...
            <p className="text-white/75 text-lg leading-relaxed">
              הוא לא בוחר להתפוצץ. הוא לא עושה לך את זה. הוא מוצף — ואתם המקום הכי בטוח שלו לשפוך.
            </p>
            <p className="mt-4 text-white font-bold text-lg">כשמבינים את זה — לא מגיבים מהמקום הנעלב. מגיבים מהמקום שיודע.</p>
          </motion.div>
      ...
      <section className="py-20 lg:py-32 px-6 lg:px-16 bg-white">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            {[
              {
                title: "הבנה שמשנה הכל",
                text: "תדעי מה קורה ביולוגית בגיל 8-11 — ותפסיקי להרגיש שאת הולכת על ביצים בבית שלך",
                color: "bg-[#A0522D]",
              },
              {
                title: "ויסות שמגיע מהידע",
                text: "תדעי להחזיק אותו כשהוא מתפרק — מבלי להתפרק איתו. זה שרוצה לצעוק ולא צועקת",
                color: "bg-[#b8916a]",
              },
              {
                title: "גבולות שהוא מקבל",
                text: "תגידי לא בלי שכל ערב יהפוך לקרב — כי תביני מה קורה אצלו כשאת אומרת לו לא",
                color: "bg-[#2C3E5A]",
              },
              {
                title: "יכולת תיקון",
                text: "אחרי שצעקת, אחרי הפיצוץ — תדעי בדיוק מה לעשות. וזה מה שבונה ביניכם אמון אמיתי",
                color: "bg-[#8a7560]",
              },
            ].map((item, i) => (
              <motion.div
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <div className="space-y-5">
            {[
              {
                Icon: Icon.video,
                title: "4 לייבים שבועיים של 90 דקות",
              ...
              {
                Icon: Icon.video,
                title: "סיכום כתוב לכל מפגש",
                tag: "לא תצטרכי לרשום",
                text: "אחרי כל מפגש מחכה לך סיכום מסודר עם כל הנקודות המרכזיות והכלים — כדי שתוכלי לחזור ולקרוא בקצב שלך.",
              },
              {
                Icon: Icon.check,
                title: "KIT משימות שבועי",
                tag: "עבודה בין המפגשים",
                text: "כלי קצר לעבודה בבית בין מפגש למפגש — כדי שמה שלמדת יישאר איתך גם בשטח.",
              },
            ].map((bonus, i) => (
              <motion.div
                key={i}
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-14 items-start">
            ...
            <div className="flex-1">
              ...
              >
                <p>
                  אני מאמינה שכל אחת מאיתנו צריכה החזקה.
                </p>
                <p>
                ...
                <div className="space-y-2 border-r-2 border-[#A0522D]/30 pr-4">
                  ...
                  <p>זה לא הכל או כלום. 50% עדיף על 0% — תמיד.</p>
                  <p className="font-semibold text-[#2C3E5A]">זה לא מאוחר מדי לשפר את מערכת היחסים שלך עם הילד שלך. לא אחרי הפיצוץ האחרון. לא בגיל 9. עכשיו זה הזמן.</p>
                </div>
                <p>
      ...
      <section className="py-20 lg:py-32 px-6 lg:px-16 bg-[#2C3E5A] relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative z-10 text-center">
          ...
          >
            ...
            >
              497 <span className="text-[#C8956C] text-4xl lg:text-5xl align-middle">ש&quot;ח</span>
            </motion.p>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <p className="text-[#2C3E5A]/70 text-xl leading-relaxed mb-4">
              בדיוק בגלל שזה המחזור הראשון, המחיר משקף את זה.
              497 ש&quot;ח במקום 597 — זו הזדמנות שלא תחזור.
            </p>
              ...
              >
                ...
                <label className="flex items-start gap-3 text-right cursor-pointer">
                  <input
                    ...
                    className="mt-1 flex-shrink-0 accent-[#A0522D] w-4 h-4"
                  />
                  <span className="text-[#2C3E5A]/60 text-sm leading-relaxed">
                    אני מסכימה לקבל תכנים ועדכונים מהדר ארקדש.{" "}
                    <a href="/privacy" className="text-[#A0522D] underline">מדיניות הפרטיות</a>
                  </span>
                </label>
                ...
                <motion.button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-[#A0522D] text-white font-bold py-5 text-xl relative overflow-hidden disabled:opacity-60"
                  whileHover={{ scale: 1.01 }}
                  whileTap={{ scale: 0.98 }}
                >
                  {loading ? "שולחת..." : "אני בפנים, שרייני לי מקום"}
                </motion.button>
