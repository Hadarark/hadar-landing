  ...
  const weeks = [
    {
      ...
      text: "מ-13:00 שהוא יוצא מהלימודים ועד 17:00 שאת מגיעה הביתה — ארבע שעות שאת לא שם. ואת כבר יודעת מה מחכה. הפיצוץ לא מחכה לדלת. לפעמים הוא מתחיל כבר בטלפון, באמצע יום עבודה. נבין מה קורה ביולוגית בגיל הזה, ולמה זה קורה בדיוק בשעות האלה — ואיך שוברים את המעגל.",
    },
    {
      num: "02",
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <p className="text-[#2C3E5A]/70 text-xl leading-relaxed mb-4">
              בדיוק בגלל שזה מחזור ראשון, המחיר משקף את זה.
              497 ש&quot;ח זה לא הימור. זו הזדמנות לבדוק עם אפס סיכון.
            </p>
