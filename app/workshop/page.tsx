  ...
  const weeks = [
    {
      ...
      text: "מה קורה ביולוגית ונוירולוגית בגיל 8-11 — ולמה הילד שמולך הוא לא הילד שגידלת. הוואקום של אחה\"צ: מ-13:00 שיוצא מהלימודים ועד שאת מגיעה — ולמה בדיוק בשעות האלה הכי הרבה ריבים פורצים. פלוס: 4 מלכודות הוריות שרובנו נופלות בהן בלי לשים לב.",
    },
    {
      num: "02",
      title: "לא אשמים, אבל כן אחראיים",
      text: "ויסות הורי — כי כשאתם מאבדים את עצמכם, הוא מאבד אתכם. נלמד על שורשי האהבה לפי אריך פרום, ועל 'שתי אמיתות' — הדרך להחזיק אותו כשהוא מתפרק מבלי להתפרק איתו. פלוס: 4 מלכודות הוריות.",
    },
    {
      num: "03",
      title: "גבולות — איך עושים את זה נכון?",
      text: "מה קורה אצלו באמת כשאת אומרת לו 'לא' — ולמה גבולות הם דווקא מה שהוא הכי צריך ממך. דמעות חוסר תוחלת: למה הן בעצם חדשות טובות. ניהול מסכים בלי פאניקה ובלי לייצר כל ערב קרב. פלוס: 4 מלכודות הוריות.",
    },
    {
      num: "04",
      title: "אמנות התיקון",
      text: "כולנו מתפוצצים — זה לא השאלה. השאלה היא מה עושים אחרי. תיקון בארבעה צעדים שאפשר ליישם מחר בבוקר. הסיפור בראש לפי ברנה בראון — ולמה הפיצוץ הוא לא הסוף, אלא נקודת ההתחלה של הקשר האמיתי.",
    },
  ];
